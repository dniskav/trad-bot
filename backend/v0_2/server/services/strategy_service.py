...
class StrategyService:
    ...
    async def start_strategy(self, name: str) -> bool:
        """Start a strategy"""
        return await self.strategy_engine.start_strategy(name)

    async def stop_strategy(self, name: str) -> bool:
        """Stop a strategy"""
        return await self.strategy_engine.stop_strategy(name)
    ...
    async def load_strategy(self, strategy_name: str) -> bool:
        ...
        return await self.strategy_engine.load_strategy_by_name(strategy_name)
    
    async def unload_strategy(self, strategy_name: str) -> bool:
        """Unload a strategy by name"""
        return await self.strategy_engine.unload_strategy(strategy_name)
