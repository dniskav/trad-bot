...
class AccountServiceAdapter:
    ...
    async def get_account_synth(self) -> Dict[str, Any]:
        ...
        try:
            ...
            account_details = await self.account_service.get_account_details("main_account")
    ...
    async def reset_account_synth(self) -> Dict[str, Any]:
        ...
        try:
            ...
            initial_balance = await self.account_service.create_initial_balance_changes()
    ...
    def _convert_to_legacy_format(self, account_details: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def initialize(self):
        ...
        try:
            ...
            if not account_service:
                raise Exception("Failed to resolve AccountApplicationService from DI Container")
