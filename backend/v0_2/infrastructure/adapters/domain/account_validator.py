...
class StandardAccountValidator:
    ...
    def __init__(self):
        ...
        self.transaction_limits = {
            ...
            TransactionType.WITHDRAWAL: Money.from_float(5000.0), # Máximo $5k withdrawal
            TransactionType.COMMISSION: Money.from_float(100.0),   # Máximo $100 comisión
            TransactionType.TRADE_PNL: Money.from_float(1000.0),   # Máximo $1k P&L por trade
            TransactionType.POSITION_OPEN: Money.from_float(2000.0), # Máximo $2k posición
    ...
    async def validate_account_activity(
        self, 
        account: AccountAggregate
    ) -> bool:
...
class AdvancedAccountValidator(StandardAccountValidator):
    ...
    def __init__(self):
        ...
        self.vip_limits = {
            0: {"daily": Money.from_float(5000.0), "monthly": Money.from_float(100000.0)},
            1: {"daily": Money.from_float(10000.0), "monthly": Money.from_float(250000.0)},
            2: {"daily": Money.from_float(50000.0), "monthly": Money.from_float(500000.0)},
            3: {"daily": Money.from_float(100000.0), "monthly": Money.from_float(1000000.0)},
            4: {"daily": Money.from_float(250000.0), "monthly": Money.from_float(2000000.0)},
        }
    ...
    async def validate_vip_transaction(
        ...
        vip_multiplier = {
            ...
            TransactionType.POSITION_OPEN: Decimal("2.0"), # VIP posiciones 2x más grandes
            TransactionType.COMMISSION: Decimal("10.0")    # VIP puede pagar comisiones más altas
        }
        
        multiplier = vip_multiplier.get(transaction_type, Decimal("1.0"))
        adjusted_limit = Money(
            self.transaction_limits.get(transaction_type, Money.zero("USDT")).amount * multiplier,
            "USDT"
        )
    ...
    async def validate_knowledge_check(
        ...
        needs_knowledge_check = (
            position_size_usdt.amount > large_position_threshold.amount or
