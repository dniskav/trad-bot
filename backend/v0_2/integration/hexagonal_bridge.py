...
from ..infrastructure.di_configuration import (
...
class HexagonalBridge:
    ...
    async def open_position_bridge(
        ...
        try:
            ...
            # Parsear side
            side_enum = (
                OrderSide.BUY if side.strip().upper() == "BUY" else OrderSide.SELL
            )
    ...
    async def close_position_bridge(
    ...
    async def get_position_status_bridge(
    ...
    async def binance_margin_order_bridge(
        ...
        try:
            ...
            if (
                ...
                and len(request_data.get("stopPrice", "")) == 0
            ):
                ...
                result = await self.open_position_bridge(
                    ...
                    leverage=leverage,
                    price=(
                        float(request_data.get("price", 0))
    ...
    async def _handle_sl_tp_order_bridge(
        self, request_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    async def test_bridge():
        ...
        result = await bridge.open_position_bridge(
            symbol="DOGEUSDT", side="BUY", quantity="100"
        )
