...
async def create_websocket_service() -> "WebSocketService":
    ...
    """
    try:
        from shared.infrastructure.adapters.communication.websocket_service import (
            WebSocketService,
...
async def get_websocket_manager():
    ...
    try:
        ...
        try:
            ...
            # Crear instancia legacy directamente
            websocket_service = WebSocketService()
            adapter = WebSocketServiceAdapter(websocket_service)
            return adapter
