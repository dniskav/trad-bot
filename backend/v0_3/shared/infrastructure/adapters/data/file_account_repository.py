...
class FileAccountRepository:
                    ...
                    balance_change = BalanceChange.from_dict(
                        {
                            ...
                            "related_position_id": change_dict.get(
                                "related_position_id"
                            ),
    ...
    def get_account_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if accounts_data:
                ...
                for account_data in accounts_data:
                    try:
                        balance = float(account_data.get("total_balance_usdt", 0) or 0)
                ...
                if balances:
                    ...
                    stats["average_balance_usdt"] = stats["total_balance_usdt"] / len(
                        balances
                    )
    ...
    def migrate_from_legacy_account(
        self, legacy_account_data: Dict[str, Any]
    ) -> AccountAggregate:
