...
const WebSocketManager: React.FC = () => {
  ...
  // Hook para conexión a Binance - DESACTIVADO PARA DIAGNÓSTICO
  // const binanceSocket = useBinanceSocket({ symbol: 'dogeusdt', interval: '1m' })

  // Actualizar estado de conexión Binance - DESACTIVADO PARA DIAGNÓSTICO
  // useEffect(() => {
  ...
  // Procesar mensajes de Binance y enviarlos al contexto - DESACTIVADO PARA DIAGNÓSTICO
  // useEffect(() => {
